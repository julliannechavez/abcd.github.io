                    ...
                    <table class="table table-stripped table-bordered" id="academic-history">
                        ...
                        <thead>
                            <tr class="bg-gradient-dark">
                                ...
                                <th class="py-1 text-center">Department/Strand</th>
                        ...
                        <tbody>
                            <?php 
                            $i= 1;
                            $academics = $conn->query("SELECT a.*,c.name as strand, d.name as department FROM `academic_history` a inner join course_list c on a.course_id = c.id inner join department_list d on c.department_id = d.id where student_id = '{$id}' order by a.school_year asc, d.name asc, c.name asc ");
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1 align-middle">
                                    ...
                                    <small><span class=""><?= $row['strand'] ?></span></small>
                                </td>
                                <td class="px-2 py-1 align-middle">
